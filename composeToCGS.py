# -*- coding: utf-8 -*-
"""
Created on Mon Sep 19 12:28:49 2022
...
#%% Functions
def getData(table):
    data=np.loadtxt(table, skiprows=1)
    N=len(data)
    ...
    for i in range (0, N):
        ...
        epsAd[i] = data[i][4]
    fend={}
    fend['rho'] = rho*1.66e15 #Transform to cgs
    fend['P'] = P*1.7827e12
    fend['epsAd'] = epsAd
    return fend
...
#%% Transform tables
path="C:\\Users\\marin\\Desktop\\REPO\\94_coldEoSTablesCompose\\"

EOS=['BHF_BBB2', 'KDE0V', 'KDE0V1','SKOP', 'SLY2', 'SLY230A', 'SKMP', 'RS', 'SK255', 'SLY9', 'SKI2', 'SKI3', 'SKI4', 'SKI5', 'SKI6', 'SK272']

#From compose tables with header
#
#    T[Mev], nb [fm^-3], Y_q [], P [Mev fm^-3], E/m_n-1 []
#
